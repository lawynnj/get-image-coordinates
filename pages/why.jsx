...
export default () => {
  return (
    <Layout title="Why? - The motivation">
      <Jumbotron style={{ height: "100vh", marginBottom: 0 }}>
        ...
        <h2>Solution</h2>
        <p>
          To make this tedious process more efficient, I created an app that
          allows us to upload an image and click on a point in the image to copy
          the coordinates in a custom format. In our case it was JSON format.
        </p>
      </Jumbotron>
    </Layout>
  );
